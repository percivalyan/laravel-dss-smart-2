    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Edit Alternative</h4>
                    </div>
                    <div class="content">
                        <form action="{{ route('alternative.update', $alternative->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alternative_code" id="alternative_code"
                                    ...
                                    value="{{ old('alternative_code', $alternative->alternative_code) }}" required>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="alternative_name" id="alternative_name"
                                    ...
                                    value="{{ old('alternative_name', $alternative->alternative_name) }}" required>
